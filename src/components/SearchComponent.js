...
//   handleSubmit = e => {
//     e.preventDefault();
//     fetchRestaurantsByCity(e.target.city.value).then(data =>
...
//         id: 89,
//         image_url:
//           "https://images.unsplash.com/photo-1517933029403-91a9781f7d77?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80"
//       },
//       {
//         name: "Vancouver",
//         country: "Canada",
...
//             {cities.map(city => (
//               <option name="city" key={city.id} value={city.id}>
//                 {city.name}
//               </option>
//             ))}
//           </select>
